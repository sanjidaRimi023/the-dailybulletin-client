...
const cardData = [
  ...
  },
  {
    ...
    image: "https://i.ibb.co/8LT8W7jN/portrait-confident-young-businessman-with-his-arms-crossed.jpg",
  },
  {
    id: 5,
    name: "Nusrat Jahan",
    ...
    image: "https://i.ibb.co/Zp6ktS7q/photorealistic-lawyer-day-celebration.jpg",
  },
];
...
export default function Testimonials() {
  ...
  useEffect(() => {
    if (!isPaused) {
      autoplayRef.current = setInterval(() => setActiveIndex(prev => (prev + 1) % cardData.length), autoplayDelay);
    }
  ...
  return (
    <section className="w-full py-12 px-4 md:px-8 dark:bg-gray-900">
      <div className="container mx-auto flex flex-col md:flex-row items-start md:items-center gap-10">
        ...
        <div className="md:w-1/3 text-left">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-base md:text-lg">
            Hear from our community of satisfied readers who love our content and keep coming back for more insights.
          </p>
        </div>
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4 mt-6">
            <button
              ...
              className="p-2 rounded-full bg-gray-200 dark:bg-white/10 hover:bg-gray-300 dark:hover:bg-white/20 text-gray-700 dark:text-white transition-colors"
            >
              <ChevronLeftIcon />
            </button>
              ...
              {cardData.map((_, idx) => (
                <span
                  ...
                  className={`h-2 rounded-full transition-all duration-300 ${
                    idx === activeIndex ? "w-6 bg-indigo-500" : "w-2 bg-gray-300 dark:bg-neutral-600"
                  }`}
                />
              ))}
            </div>
...
function Card({ card, index, activeIndex, totalCards }) {
  ...
  return (
    ...
    >
      <div className="w-full h-full rounded-3xl bg-gradient-to-br from-white to-gray-100 dark:from-neutral-800 dark:to-neutral-900 flex flex-col overflow-hidden border border-gray-200 dark:border-neutral-700 transition-transform duration-500">
        ...
        <div className="flex flex-col flex-grow p-5 text-left">
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{card.name}</h3>
          <p className="text-gray-700 dark:text-gray-300 text-sm flex-grow overflow-hidden leading-relaxed">
            "{card.review}"
          </p>
