...
const UserOverView = () => {
  ...
  const pieData = [
    { name: "Approved", value: stats.approved || 4 },
    { name: "Pending", value: stats.pending || 2 },
    ...
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-1">Here's a summary of your activity.</p>
        </div>
