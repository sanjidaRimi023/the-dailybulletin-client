...
export default function DashboardLayout() {
    ...
    return (
        <div className="flex">
            <aside class="w-64 px-4 py-8 bg-white border-r rtl:border-r-0 rtl:border-l border-gray-400">
                <div className="flex flex-col min-h-[95vh] fixed">
                    <Link to="/">
                        <img class="w-auto h-10 sm:h-7" src={logo} alt="" />
                    </Link>

                    <div class="flex w-full flex-col justify-between flex-1 mt-6">
